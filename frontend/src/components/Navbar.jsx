...
export default function Navbar() {
  ...
  const [textSize, setTextSize]         = useState(
    () => localStorage.getItem('healthbeacon_textsize') || 'medium'
  )
  ...
  useEffect(() => {
    ...
    localStorage.setItem('healthbeacon_textsize', textSize)
  }, [textSize])
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 h-full flex items-center justify-between gap-2">
        ...
        >
          ...
          <span className="font-bold text-slate-800 dark:text-slate-100 text-sm sm:text-base">
            Health<span className="text-primary-600 dark:text-primary-400">Beacon</span>
          </span>
        </div>
